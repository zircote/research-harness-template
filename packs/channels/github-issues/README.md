...
- **[github-issues — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/channels/#github-issues)** — its purpose, constraints, goals,
  and how to enable it.

**Dependencies:** gh, jq

The pack source lives in this directory. It ships disabled; enable it with
`scripts/pack-toggle.sh github-issues on`. See the
