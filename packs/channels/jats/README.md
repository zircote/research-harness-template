...
- **[jats — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/channels/#jats)** — its purpose, constraints, goals,
  and how to enable it.

**Dependencies:** jq, xmllint (optional)

The pack source lives in this directory. It ships disabled; enable it with
`scripts/pack-toggle.sh jats on`. See the
