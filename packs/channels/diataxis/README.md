...
- **[diataxis — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/channels/#diataxis)** — its purpose, constraints, goals,
  and how to enable it.

**Dependencies:** jq

The pack source lives in this directory. It ships disabled; enable it with
`scripts/pack-toggle.sh diataxis on`. See the
