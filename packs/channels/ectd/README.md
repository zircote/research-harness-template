...
- **[ectd — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/channels/#ectd)** — its purpose, constraints, goals,
  and how to enable it.

**Dependencies:** jq

The pack source lives in this directory. It ships disabled; enable it with
`scripts/pack-toggle.sh ectd on`. See the
