...
- **[notebooklm — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/channels/#notebooklm)** — its purpose, constraints, goals,
  and how to enable it.

**Dependencies:** nlm, jq, python3

The pack source lives in this directory. It ships disabled; enable it with
`scripts/pack-toggle.sh notebooklm on`. See the
