...
- **[software-security — pack reference](https://modeled-information-format.github.io/research-harness/reference/packs/ontologies/#software-security)** — its purpose, constraints, goals,
