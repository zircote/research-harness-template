...
- **[observability — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/ontologies/#observability)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh observability on`. See the
