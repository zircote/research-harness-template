...
- **[market-research — pack reference](https://modeled-information-format.github.io/research-harness/reference/packs/ontologies/#market-research)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh market-research on`. See the
