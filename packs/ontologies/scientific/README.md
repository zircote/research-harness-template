...
- **[scientific — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/ontologies/#scientific)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh scientific on`. See the
