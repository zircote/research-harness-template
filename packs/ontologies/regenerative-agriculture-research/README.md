...
- **[regenerative-agriculture-research — pack reference](https://modeled-information-format.github.io/research-harness/reference/packs/ontologies/#regenerative-agriculture-research)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh regenerative-agriculture-research on`. See the
