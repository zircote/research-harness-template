...
- **[software-engineering — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/ontologies/#software-engineering)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh software-engineering on`. See the
