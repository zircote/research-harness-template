...
- **[regenerative-agriculture — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/ontologies/#regenerative-agriculture)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh regenerative-agriculture on`. See the
