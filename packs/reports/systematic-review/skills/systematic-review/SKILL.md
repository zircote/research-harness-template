...
- **Figures**: the **PRISMA flow diagram is REQUIRED** — a diagram (Mermaid flowchart or
  equivalent) showing the count of records at each stage: **identified → screened →
  excluded (with reasons) → included**. A risk-of-bias / verification-verdict table is
