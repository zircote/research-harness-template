...
- **[financial-analysis — pack reference](https://modeled-information-format.github.io/research-harness-template/reference/packs/market-research/#financial-analysis)** — its purpose, constraints, goals,
...
`scripts/pack-toggle.sh financial-analysis on`. See the
